...
\begin{itemize}
    ...
    Let's consider two lines with equations \( y =m_1x + c_1 \) and \( y = m_2x + c_2 \). We are interested in finding the point of intersection of these two lines.\\[2mm]
        \begin{center}
            \begin{tikzpicture}
                \tzaxes(-2, -1.5)(7, 4){$x$}{$y$}
                \tzcoors*(3, 2)(P) (1, 0)(A) (5, 0)(B);
                \tzLFn(A)(P)[-0.5:5]{$y=m_1x+c_1$}[r]
                \tzLFn(B)(P)[0.5:6]{$y=m_2x+c_2$}[l]
                \tzanglemark(B)(A)(P){$\theta_1$}[pos=2]
                \tzanglemark(6, 0)(B)(P){$\theta_2$}[pos=2]
                \tzanglemark(A)(P)(B){$\theta$}[pos=2]
            \end{tikzpicture}
        \end{center}
        \begin{align*}
