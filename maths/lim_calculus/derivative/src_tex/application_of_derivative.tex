...
\addcontentsline{toc}{subsubsection}{Geometrical Interpretation of Derivative}
...
\addcontentsline{toc}{subsubsection}{Rate of Change}
\vbsubtitle{$\frac{dy}{dx}$ as rate of change:}
\vbdefinition{
    From the slope of straight line you already know that $\frac{\Delta y}{ \Delta x}$ represents the rate of change of $y$ with respect to $x$. \\[2 mm]
    \begin{align*}
        \lim_{\Delta x \to 0} \frac{\Delta y}{\Delta x} &= \frac{dy}{dx}\\
        \intertext{This means that the derivative of a function at a point is the rate of change of the function at that point.}
        \intertext{In Physics, we define many quantities in terms of rate of change. For example, velocity is the rate of change of displacement with respect to time. Acceleration is the rate of change of velocity with respect to time. Force is the rate of change of linear momentum with respect to time. So, all these quantities can be expressed in terms of derivatives.}
    \end{align*}
}
...
% \addcontentsline{toc}{subsubsection}{Maxima and Minima}
