\documentclass[tikz, svgnames, margin=10mm]{standalone}

\usetikzlibrary{mindmap}

\begin{document}
\begin{tikzpicture}[
    mindmap, every node/.style=concept, concept color=orange, text=black,
    level 1/.append style={level distance=5cm, sibling angle=60, font=\large},
    level 2/.append style={level distance=3cm, sibling angle=45}
  ]

  \node{\textbf{\huge{Physics}}} [clockwise from=0]
  child [concept color=black, text=white] {
